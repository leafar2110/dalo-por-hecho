                                                    ...
                                                    <div class="row border-n mb-5">
                                                        <div class="col-md-12">
                                                            <div class="ofertas_titulos mb-3">
                                                                ...
                                                                <div class="flex ml-3">
                                                                    <span><a title="Perfil usuario" href="perfil?post=<?=$id_empleador ?>">   <?php echo meta_user_value( 'first_name',  $id_empleador ); echo ' '; echo meta_user_value( 'last_name',  $id_empleador );?></a>
                                                                    </span>
                                                                    <div>
                                                                    <?php
                                                                ...
                                                                <a class="ml-auto" href="" data-toggle="modal" data-target="#modal_chat_<?php echo $id_tarea_a; ?>"  aria-hidden="true"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Ir al chat</a> 
