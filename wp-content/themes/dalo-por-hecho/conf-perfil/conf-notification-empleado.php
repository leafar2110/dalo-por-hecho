...
<div class="tab-pane fade " id="v-pills-notification-empleado" role="tabpanel" aria-labelledby="v-pills-tareas-tab">
  ...
  <div class="tab-content"> 
    <!-- Notificaciones -->                                    
    <div id="notifi-e" class="container tab-pane active"><br>
      <?php $args = 
        array(
            ...
            <div class="datos_name">
              <div class="row border-n mb-5">
                <div class="col-md-12">
                  ...
                  <div class="cube mb-4"> 
                    <p>$ <?php echo number_format(the_field('ofertar_monto_tarea'), 0, '.', '.'); ?></p>
                  </div>
                  <div class="respnse">
    ...
    <!-- Chat -->                                    
    <div id="chate-e" class="container tab-pane  fade"><br>
      <?php                          
        $id_tarea_a  = 0;
        $args3 = array (
          'post_type' => 'asignados',
        ...
        $loop3 = new WP_Query( $args3 ); 
          while ( $loop3->have_posts() ) : $loop3->the_post(); $comision = (get_field('ofertar_monto_tarea')*0.10); $asignar_id_empleado = get_field( 'asignar_id_empleado' );$id_empleador = get_post(get_field( 'asignar_id_tarea_publicada' ))->post_author; $id_tarea_a = get_field( 'asignar_id_tarea_publicada' );  $cod_chat = $id_tarea_a.'-'.$id_empleador.'-'.$current_user->ID;
            $rating_postulado  = get_field('asignar_id_empleado');?>
            <?php echo '<p class="active show">'.get_field( 'asignar_name_tarea_publicada' ).'</p>';  ?>
            ...
            <div class="ofertas_conetnt">
              <div class="datos_name">
                <div class="row border-n mb-5">
                  <div class="col-md-12">
                    <div class="ofertas_titulos mb-3">
                      <a title="Perfil usuario" href="perfil?post=<?=$id_empleador ?>">
                        <?php echo get_avatar( user_value( $id_empleador ), 50 );?>
                      </a> 
                      <div class="flex ml-3">
                        <span>
                          <a title="Perfil usuario" href="perfil?post=<?=$id_empleador ?>">   <?php echo meta_user_value( 'first_name',  $id_empleador ); echo ' '; echo meta_user_value( 'last_name',  $id_empleador );?>
                          </a>
                        </span>
                        <div>
                          <?php
                      ...
                      <a class="ml-auto btn-general" href="" data-toggle="modal" data-target="#modal_chat_<?php echo $id_tarea_a; ?>"  aria-hidden="true"> Ir al chat</a> 
                      <!-- Modal chat -->
                        <div class="modal fade modal-chat" id="modal_chat_<?php echo $id_tarea_a; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="datos_genereal">
                                  <div class="main-task__minigrid">
                                    <?php 
                                      ...
                                      while ( $loops->have_posts() ) : $loops->the_post(); $id_p = get_the_ID();
                                            ...
                                            $meta_key = 'visto_chat';
                                            $meta_value = 'si'; 
                                            if (get_field( 'id_user_chat' ) == $current_user->ID AND get_field( 'visto_chat' ) == 'no') {
                                  ...
                                  <div class="col-lg-12">
                                    <?php if (is_user_logged_in() != NULL){
                                      $visto = 'no'; 
                                      echo do_shortcode('[frm-set-get id_tareas_chat_copy='.$id_tarea_a.'][frm-set-get id_user_chat='.$id_empleador.'][frm-set-get visto_chat='.$visto.'][frm-set-get cod_chat='.$cod_chat.'][frm-set-get id_chat=NULL][formidable id=18]');  ?>
                                  <?php } ?> 
                                </div> 
                              </div>    
                            </div>
