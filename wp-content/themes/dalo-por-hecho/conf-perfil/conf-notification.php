                                                    ...
                                                    <div class="row border-n mb-5">
                                                        <div class="col-md-12">
                                                            <div class="ofertas_titulos mb-3">
                                                                ...
                                                                <a class="ml-auto" href="" data-toggle="modal" data-target="#modal_chat_<?php echo $cod_chat; ?>"  aria-hidden="true"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Ir al chat</a> 

                        
                                                                <!-- Modal chat -->
                                                                <div class="modal fade" id="modal_chat_<?php echo $cod_chat; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
